...
namespace LocadoraAPI.Migrations
{
    ...
    [Migration("20221123123859_Adicionando Sessao Relacionando com Cinema e Filme")]
    partial class AdicionandoSessaoRelacionandocomCinemaeFilme
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocadoraAPI.Models.Gerente1", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LocadoraAPI.Models.Cinema", b =>
                {
                    ...
                    b.HasOne("LocadoraAPI.Models.Gerente1", "Gerente")
                        .WithMany("Cinemas")
            ...
            modelBuilder.Entity("LocadoraAPI.Models.Sessao", b =>
                {
                    b.HasOne("LocadoraAPI.Models.Cinema", "Cinemas")
                        .WithMany("Sessoes")
                        .HasForeignKey("CinemaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LocadoraAPI.Models.Filme", "Filmes")
                        .WithMany("Sessoes")
